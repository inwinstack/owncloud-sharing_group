<div id="controls">
        ...
        <?php if(\OC_Config::getValue('sharing_group_mode') == 'Friend_mode'){ ?>
            ...
            <div id="sg-dialog" title="<?php p($l->t('Add friends')) ?>">
                <form class="sg-searchbox" action="" method="GET">
                    <input id="sg-addfriend-searchbox" placeholder="test@email.com" type="search" tabindex="5">
    ...
    <input id="sg-searchfriend-searchbox" type="input" tabindex="5">
    <button type="button" id="sg-searchfriend-cancel" style="display:none">
        <?php p($l->t('Cancel'))?>
    </button>
</div>
